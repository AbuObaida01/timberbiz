...
def send_password_reset_email(
    ...
    The reset token is embedded in the reset link and is never logged.

    Returns:
        True: Email was successfully accepted by Resend.
    ...
    try:
        ...
        # Do not log reset_token or reset_link
        logger.info(
        ...
        # Log the actual Resend error.
        # The reset token is NOT included in the log.
        logger.error(
